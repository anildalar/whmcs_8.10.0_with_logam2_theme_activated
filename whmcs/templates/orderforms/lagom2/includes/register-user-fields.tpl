...
{else}
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <label for="inputCompanyName" class="control-label {if isset($RSThemes['pages'][$templatefile]['config']['companyNameRequired']) && $RSThemes['pages'][$templatefile]['config']['companyNameRequired'] == "1"}label-required{/if}">
