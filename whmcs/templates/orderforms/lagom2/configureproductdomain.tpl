...
{else}	
    ...
    <div class="main-content {if $mainContentClasses}{$mainContentClasses}{/if}">
        <form id="frmProductDomain" {if isset($RSThemes['addonSettings']['tld_cycle_switcher']) && $RSThemes['addonSettings']['tld_cycle_switcher'] == 'true'}action="{$WEB_ROOT}/cart.php" data-show-tld-cycle-switcher {if isset($smarty.get.period)}data-period="{$smarty.get.period}"{/if}{/if}>
