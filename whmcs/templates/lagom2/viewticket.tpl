            ...
            <div class="ticket-reply{if $reply.admin} staff{/if}">
                <div class="ticket-reply-top">
                    {if $RSThemes.addonSettings.show_gravatar_image == 'displayed'}
                        <div class="client-avatar client-avatar-md">
                        ...
                        <ul>
                            {foreach from=$reply.attachments key=num item=attachment}
                                ...
                                {else}
                                    ...
                                    {$attachmentExtension = '.'|cat:{$attachmentArray|@end}}
                                    {$attachmentName = $attachment|replace:".{$attachmentExtension}":""}
                                    <li>
                                        <a href="dl.php?type={if $reply.id}ar&id={$reply.id}{else}a&id={$id}{/if}&i={$num}">
                                            ...
                                            <div class="attachment-container">
                                                ...
                                                <span class="attachment-extension">{$attachmentExtension}</span>
                                            </div>
                                        </a>
                                    </li>
                                {/if}
