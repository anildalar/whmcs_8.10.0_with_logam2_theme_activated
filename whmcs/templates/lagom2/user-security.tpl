        ...
        <div class="panel panel-default">
            <ul class="panel-tabs nav nav-tabs">
                ...
                {if $twoFactorAuthAvailable}
                    <li>
                        <a {if !$linkableProviders}class="active"{/if} href="#twofa" data-toggle="tab" aria-expanded="false">
                        <i class="ls ls-security-code"></i>{$LANG.twofactorauth} </a>
                    </li>
                {/if}
                {if $securityQuestions->count() > 0}
                    <li>
                        <a {if !$linkableProviders && !$twoFactorAuthAvailable}class="active"{/if} href="#change-security-question"  data-toggle="tab" aria-expanded="false">
