...
{else}
    ...
    <form method="post" class="loginForm" action="{$smarty.server.PHP_SELF}" role="form" name="orderfrm" id="frmCheckout">
            ...
            <div class="section section-sm">
                ...
                <div class="section-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group ">
                                <label for="inputCompanyName" {if isset($RSThemes['pages'][$templatefile]['config']['companyNameRequired']) && $RSThemes['pages'][$templatefile]['config']['companyNameRequired'] == "1"}class="label-required"{/if}>
                                    {$LANG.orderForm.companyName} {if isset($RSThemes['pages'][$templatefile]['config']['companyNameRequired']) && $RSThemes['pages'][$templatefile]['config']['companyNameRequired'] == "1"}{else}({$LANG.orderForm.optional}){/if}
                                </label>
                                <input type="text" name="companyname" id="inputCompanyName" class="form-control" placeholder="" value="{$clientcompanyname}" {if isset($RSThemes['pages'][$templatefile]['config']['companyNameRequired']) && $RSThemes['pages'][$templatefile]['config']['companyNameRequired'] == "1"}required{/if}>
                            </div>
                        </div>
                        {if $showTaxIdField}
                            <div class="col-md-6">  
        ...
        {if $showMarketingEmailOptIn}
            <div class="section section-sm {if isset($RSThemes['pages'][$templatefile]) && isset($RSThemes['pages'][$templatefile]['config']['hideJoinToMailingList']) && $RSThemes['pages'][$templatefile] && $RSThemes['pages'][$templatefile]['config']['hideJoinToMailingList'] == "1"} hidden{/if}">
                <div class="section-header">
