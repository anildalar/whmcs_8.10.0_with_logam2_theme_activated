...
{if $type == "switcher"}
    ...
    <label class="d-flex" data-inactive-services>
        ...
        <span data-inactive-services-text="hidden"{if $hideInactiveServices['inactiveServices']}class="hidden"{/if}>{if $serviceCounter == 1}{$rslang->trans('hide_incactive_services.services.hidden')|replace:"%s":$serviceCounter}{else}{$rslang->trans('hide_incactive_services.services.hidden_plural')|replace:"%s":$serviceCounter}{/if}</span>
