...
return [
    ...
    'settings'     => [
        ...
        'hideTicketPriority' => [
            'type' => 'checkbox',
            'name' => 'hideSidebar',
            'label' => 'Hide Ticket Priority',
            'tooltip' => "When option will be activated 'Priority' select will be hidden from the ticket message settings."    
        ],
        'showProductGroupInRelatedSectives' => [
            'type' => 'checkbox',
            'name' => 'productGroup',
            'label' => 'Show Product Group Name',
            'tooltip' => "Show product group in related services dropdown"    
        ],
