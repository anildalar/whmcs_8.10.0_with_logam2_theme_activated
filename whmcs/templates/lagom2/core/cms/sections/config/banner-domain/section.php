...
return [
    ...
    'fields' => [
        ...
        [
            ...
            'tooltip_url' => 'https://lagom.rsstudio.net/docs/website-builder/section-banner-domain/#banner-description'
        ],
        [
            'type' => 'text',
            'name' => 'title',
        ...
        [
            ...
            'tooltip_url' => 'https://lagom.rsstudio.net/docs/website-builder/section-banner-domain/#banner-domain-field'
        ],
        [
            'type' => 'hidden',
            'name' => 'captcha',
        ...
        [
            ...
            'tooltip_url' => 'https://lagom.rsstudio.net/docs/website-builder/section-banner-domain/#banner-background'
        ],
        [
            'type' => 'graphic',
            'name' => 'graphic',
