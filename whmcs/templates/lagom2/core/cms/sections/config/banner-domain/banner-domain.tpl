                ...
                <div class="banner-search-domain">
                    {if $domain_type == "tabs"}
                        <ul class="banner-nav nav nav-tabs">
                            <li>
                                <a class="active" href="#tab-register" data-toggle="tab">
                                    {$LANG.navdomainsearch}
                                </a>
                            </li>
                            <li>
                                <a href="#tab-transfer" data-toggle="tab">                                     
                                    {$LANG.domaintransfer}
                                </a>
                            </li>
                        </ul>
                    ...
                    {else}
                        {include file="{$smarty.current_dir}/../../common/domain-search.tpl" type=$domain_type customClass="has-shadow"}
                    {/if}        
                </div>
            {/if}
            {if $buttons}
