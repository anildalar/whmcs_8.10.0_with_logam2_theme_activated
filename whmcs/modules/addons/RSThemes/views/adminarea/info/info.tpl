                                ...
                                {if $compability === false && $isStable}
                                    <span class="notification m-l-1x">
                                        ...
                                        {include 
                                            ...
                                            popoverFooter="<a class='btn btn--secondary btn--xs' href='https://lagom.rsstudio.net/docs/common-problems/#i-m-using-incompatible-product-version' target='_blank'>{$lang.general.learn_more}</a>"
                                        }
                                    </span>
                                {/if}
                            </span>
