{if isset($sectionGroupField)}
    ...
    <div class="form-group">
        <label class="form-label">
            ...
            <a href="#newTestimonialsItemModal" class="btn btn--link btn--success m-l-a p-r-0x {if !isset($sectionGroupInputValue) || empty($sectionGroupInputValue)}is-hidden{/if}"
        ...
        {include file='adminarea/pages/includes/sortable-list.tpl'
            ...
            btnAddAction='newTestimonialsItemModal'
            btnEditAction='editTestimonialsItemModal'
...
{else}
    {*List with only media grahic inside*}
