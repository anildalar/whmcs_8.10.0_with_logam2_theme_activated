...
{if $type == "item-add" || $type == "item-edit" || $type == "product-add" || $type == "product-edit" || $type == "group-add" || $type == "group-edit" || $type == "category-add" || $type == "category-edit" || $type == "graphic-icon-add" || $type == "graphic-icon-edit"}
