...
RSThemes - Website Builder - Edit Item Modal
    ...
    <div class="modal__dialog">
        <div class="modal__content">
            ...
            <div class="modal__top top">
                <h4 class="top__title h6">Edit Item {include file="adminarea/includes/helpers/docs.tpl" link=$cms_docs->modal['item']['add_edit']['list']}</h4>
                ...
                <div class="modal__body has-scroll">
                    ...
                    <div class="modal__section">
                        ...
                        <div class="collapse show" id="list-edit-modal-tabs" data-product-tabs data-icons-tabs>
                            {include file="adminarea/pages/includes/modal/tabs.tpl" type='item-edit'}
                        </div>
                    </div>  
