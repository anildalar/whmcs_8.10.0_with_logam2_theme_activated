<div class="modal modal--lg modal--media" id="editGraphicIconModal" data-edit-graphic-icon-modal>
    <div class="modal__dialog">
        <div class="modal__content">
            ...
            <form
                id="editGraphicIconForm"
                data-edit-graphic-icon-form
            ...
            >
                <div class="modal__body">
                    {include file="adminarea/pages/includes/modal/other/icon-tabs.tpl" type='graphic-icon-edit'}
                ...
                <div class="modal__actions">
                    <button class="btn btn--primary" type="submit" form="editGraphicIconForm" data-edit-graphic-icon-btn>
