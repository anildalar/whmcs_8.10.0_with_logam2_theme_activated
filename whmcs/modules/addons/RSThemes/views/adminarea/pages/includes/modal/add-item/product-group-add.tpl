...
RSThemes - Website Builder - Add New Product Group Modal
...
<div 
    ...
    id="addNewGroupItemModal" 
    data-add-new-group-item-modal
>
    <div class="modal__dialog">
        <div class="modal__content">
            ...
            >
                <div class="modal__body overflow-y-visible" data-add-new-group-item-modal-body>
                    ...
                    <div class="modal__section is-hidden" data-product-group-info>
                        <div class="modal__section-content">         
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="item[whmcs_page]" data-product-group-page>
                            ...
                            <div class="form-group is-hidden" data-product-icon>
                                <label class="form-label is-pointer m-w-360 m-b-0x m-t-2x" data-toggle="lu-collapse" data-target="#group-add-modal-tabs">
                            ...
                            {* 2.2.5. Graphic Container *}
                            <div class="collapse" id="group-add-modal-tabs" data-product-tabs data-icons-tabs>
                                {include file="adminarea/pages/includes/modal/tabs.tpl" type='group-add'}
                            </div>
                        </div>   
                ...
                <div class="modal__actions">
                    <button class="btn btn--primary" data-add-new-group-item-btn type="submit" form="addNewGroupForm">
